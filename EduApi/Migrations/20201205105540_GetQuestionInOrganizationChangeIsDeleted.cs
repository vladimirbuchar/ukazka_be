...
{
    public partial class GetQuestionInOrganizationChangeIsDeleted : Migration
    {
...
RETURN 
( 
SELECT tq.Id, tq.Question, tq.AnswerModeId, cam.Value AS AnswerMode, sbi.Name AS BankOfQuestionName, boq.IsDefault FROM Edu_TestQuestion AS tq
