...
{
    public partial class CreateBankOfQuestionAddIsDefault : Migration
    {
...
(Id, IsDeleted, IsSystemObject, IsChanged, SystemIdentificator, OrganizationId, BasicInformationId,IsDefault) VALUES 
(@Edu_BankOfQuestion_id, 0, 0, 1, null, @OrganizationId, @BasicInformationId,@IsDefault); 
