...
{
    public partial class GetStudentQuestionAddQuestionId : Migration
    {
...
RETURN 
( 
SELECT stsq.Id, tq.Question, stsq.Score, stsq.IsTrue,am.SystemIdentificator AS AnswerMode, tq.Id  AS QuestionId FROM Edu_StudentTestSummaryQuestion AS stsq
