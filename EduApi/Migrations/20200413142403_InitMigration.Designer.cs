...
namespace EduApi.Migrations
{
    ...
    [Migration("20200413142403_InitMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Tables.CodeBook.License", b =>
                {
                    ...
                    b.Property<int>("MaximumLectors")
                        .HasColumnName("MaximumLectors")
                        .HasColumnType("int");

                    b.Property<int>("MaximumStudents")
                        .HasColumnName("MaximumStudents")
                        .HasColumnType("int");
                    ...
                    b.Property<double>("OneYearPrice")
                        .HasColumnName("OneYearPrice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Model.Tables.Edu.Branch", b =>
                {
                    ...
                    b.Property<Guid?>("ContactInformationsId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Model.Tables.Edu.User", b =>
                {
                    ...
                    b.Property<Guid?>("ObjectHistoryId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Model.Tables.Link.CourseLector", b =>
                {
                    ...
                    b.Property<Guid>("UserInOrganizationId")
                        .HasColumnName("UserInOrganizationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Model.Tables.Shared.Gallery", b =>
                {
                    ...
                    b.Property<Guid>("GalleryItemTypeId")
                        .HasColumnName("GalleryItemTypeId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Model.Tables.Link.PersonAddress", b =>
                {
                    b.HasBaseType("Model.Tables.Shared.Address");
            ...
            modelBuilder.Entity("Model.Tables.CodeBook.GalleryItemType", b =>
                {
                    b.HasOne("Model.Tables.Shared.Gallery", null)
                        .WithMany("GalleryItemType")
            ...
            modelBuilder.Entity("Model.Tables.Edu.Branch", b =>
                {
                    ...
                    b.HasOne("Model.Tables.Shared.ContactInformation", "ContactInformations")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Tables.Edu.Category", b =>
                {
                    ...
                    b.HasOne("Model.Tables.Link.CourseCategory", null)
                        .WithMany("Category")
            ...
            modelBuilder.Entity("Model.Tables.Edu.CourseTerm", b =>
                {
                    ...
                    b.HasOne("Model.Tables.Link.CourseLector", null)
                        .WithMany("CourseTerm")
                    ...
                    b.HasOne("Model.Tables.Link.CourseStudent", null)
                        .WithMany("CourseTerm")
            ...
            modelBuilder.Entity("Model.Tables.Edu.Organization", b =>
                {
                    ...
                    b.HasOne("Model.Tables.Link.UserInOrganization", null)
            ...
            modelBuilder.Entity("Model.Tables.Edu.TestQuestion", b =>
                {
                    b.HasOne("Model.Tables.Edu.CourseTest", null)
            ...
            modelBuilder.Entity("Model.Tables.Edu.User", b =>
                {
                    ...
                    b.HasOne("Model.Tables.System.ObjectHistory", null)
                        .WithMany("User")
                        .HasForeignKey("ObjectHistoryId");
