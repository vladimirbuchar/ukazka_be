...
{
    public partial class SetGoogleIdSetAvatar : Migration
    {
...
UPDATE Edu_Person SET AvatarUrl =@AvatarUrl WHERE Id = (SELECT TOP(1) PersonId FROM Edu_User WHERE Id =@UserId)
