...
{
    public partial class GetQuestionInBankAddObjectOwner2 : Migration
    {
...
boq.Id AS BankOfQuestionId,tq.QuestionModeId, cqm.Value AS QuestionMode, fr.FileName, fr.ObjectOwner
...
LEFT JOIN Edu_FileRepository AS fr ON fr.ObjectOwner = tq.Id
