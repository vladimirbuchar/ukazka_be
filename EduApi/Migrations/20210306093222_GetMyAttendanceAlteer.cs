...
{
    public partial class GetMyAttendanceAlteer : Migration
    {
...
RETURN 
( 
SELECT ctd.Date,ctd.DayOfWeek,eas.IsActive,ttf.Value AS TimeFrom, ttt.Value AS TimeTo,csbi.Name AS CourseName FROM  Edu_CourseTermDate AS ctd
