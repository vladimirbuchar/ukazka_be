...
namespace EduApi.Migrations
{
    ...
    [Migration("20210525142410_GetLectorCourseCouseWithLector")]
    partial class GetLectorCourseCouseWithLector
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Tables.CodeBook.NoteType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Model.Tables.CodeBook.QuestionMode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Model.Tables.Edu.AttendanceStudent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Model.Tables.Edu.Chat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Model.Tables.Edu.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Model.Tables.Edu.StudentEvaluation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Model.Tables.Link.StudentInGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Model.Tables.Link.StudentInGroupCourseTerm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Model.Tables.Edu.AttendanceStudent", b =>
                {
                    b.HasOne("Model.Tables.Link.CourseStudent", "CourseStudent")
                        .WithMany()
                        .HasForeignKey("CourseStudentId");

                    b.HasOne("Model.Tables.Edu.CourseTermDate", "CourseTermDate")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Tables.Edu.Chat", b =>
                {
                    ...
                    b.HasOne("Model.Tables.Edu.Chat", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Tables.Edu.Course", b =>
                {
                    ...
                    b.HasOne("Model.Tables.Edu.SendMessage", "SendMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Tables.Edu.CourseTerm", b =>
                {
                    ...
                    b.HasOne("Model.Tables.Edu.OrganizationStudyHour", "OrganizationStudyHour")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Tables.Edu.Note", b =>
                {
                    ...
                    b.HasOne("Model.Tables.CodeBook.NoteType", "NoteType")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Tables.Edu.StudentTestSummaryQuestion", b =>
                {
                    ...
                    b.HasOne("Model.Tables.CodeBook.QuestionMode", "QuestionMode")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Tables.Link.StudentInGroup", b =>
                {
                    b.HasOne("Model.Tables.Edu.StudentGroup", "StudentGroup")
                        .WithMany()
