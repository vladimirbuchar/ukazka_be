...
{
    public partial class AlterGetCourseLessonItemDetailAddFileRepository : Migration
    {
...
RETURN 
( 
SELECT ci.Id, ci.Html, sbi.Name, sbi.Description, ci.CourseLessonItemTemplateId, clit.SystemIdentificator AS TemplateIdentificator,fr.FileName,fr.OriginalFileName
