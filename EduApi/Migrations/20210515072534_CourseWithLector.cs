...
{
    public partial class CourseWithLector : Migration
    {
...
(Id, IsDeleted, IsSystemObject, IsChanged, SystemIdentificator, CourseTypeId, CourseStatusId, IsPrivateCourse, OrganizationId, BasicInformationId, CoursePriceId, StudentCountId,CertificateId,AutomaticGenerateCertificate,CourseMaterialId,SendMessageId,SendEmail,CourseWithLector) VALUES 
(@Edu_Course_id, 0, 0, 1, null, @CourseTypeId, @CourseStatusId, @IsPrivateCourse, @OrganizationId, @BasicInformationId, @CoursePriceId, @StudentCountId,@CertificateId,@AutomaticGenerateCertificate,@CourseMaterialId,@EmailTemplateId,@SendEmail,@CourseWithLector); 
...
CourseMaterialId =@CourseMaterialId, AutomaticGenerateCertificate =@AutomaticGenerateCertificate, 
SendMessageId = @EmailTemplateId,SendEmail =@SendEmail,CourseWithLector = @CourseWithLector
WHERE Id=@CourseId
...
SELECT c.Id,c.IsPrivateCourse, bi.Name, bi.Description, cp.Price, cp.Sale,
								  ...
								  c.SendMessageId,c.SendEmail,c.CourseWithLector
