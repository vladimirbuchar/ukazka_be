...
{
    public partial class AddPowerPointFileSave : Migration
    {
...
(Id, IsDeleted, IsSystemObject, IsChanged, SystemIdentificator, CourseId, BasicInformationId,Type,Position,PowerPointFile) VALUES 
(@Edu_CourseLesson_id, 0, 0, 1, null, @CourseId, @BasicInformationId,@Type,(SELECT ISNULL((SELECT MAX(Position) FROM Edu_CourseLesson WHERE IsDeleted = 0 AND CourseId =@CourseId),0)+1),@PowerPointFile ); 
