...
{
    public partial class GetBranchDetail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string sql = @"SELECT b.Id,b.IsMainBranch, a.CountryId,Region,City,Street,HouseNumber,ZipCode,Name,
                            ...
                            WHERE b.Id = @branchId AND b.IsDeleted = 0 AND a.IsDeleted = 0 AND bi.IsDeleted = 0 
                                AND c.IsDeleted = 0";
            Dictionary<string, string> param = new Dictionary<string, string>
            {
                { "@branchId", "uniqueidentifier" }
            };
            migrationBuilder.CreateSqlFunctionAsTable("GetBranchDetail", sql, param);
        }
