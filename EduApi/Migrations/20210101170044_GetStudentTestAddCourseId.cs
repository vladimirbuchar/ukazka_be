...
{
    public partial class GetStudentTestAddCourseId : Migration
    {
...
RETURN 
( 
SELECT sts.Id,  bi.Name, u.UserEmail, sts.Finish,sts.Score,sts.TestCompleted, ct.Id AS TestId, cl.CourseId 
