...
{
    public partial class GetQuestionInOrganizationBankOfQuestionPosition : Migration
    {
...
RETURN 
( 
SELECT tq.Id, tq.Question, tq.AnswerModeId, cam.Value AS AnswerMode, sbi.Name AS BankOfQuestionName, boq.IsDefault,tq.Position, boq.Position AS BankOfQuestionPosition FROM Edu_TestQuestion AS tq
