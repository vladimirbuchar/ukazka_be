...
{
    public partial class GetOrganizationSettingLoginSetting : Migration
    {
...
RETURN 
( 
SELECT eos.OrganizationId,eos.UserDefaultPassword, eo.LicenseId, dco.CultureId AS DefaultCulture, eos.ElearningUrl, eos.FacebookLogin, eos.GoogleLogin,eos.PasswordReset,eos.Registration from Edu_OrganizationSetting as eos
