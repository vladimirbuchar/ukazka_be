...
{
    public partial class GetTimeTableAddLectorName : Migration
    {
...
RETURN 
( 
SELECT ctd.Id,ctd.Date,ctd.IsCanceled,ctd.DayOfWeek, tf.Value AS TimeFrom, tt.Value AS TimeTo, csbi.Name AS ClassRoom, p.FirstName, p.LastName,p.SecondName  FROM Edu_CourseTermDate AS ctd 
