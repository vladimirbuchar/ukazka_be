...
{
    public partial class AddCourseLessonItemAddYoutube : Migration
    {
...
(Id, IsDeleted, IsSystemObject, IsChanged, SystemIdentificator, Html, CourseLessonId, BasicInformationId,CourseLessonItemTemplateId,Position, Youtube) VALUES 
(@Edu_CourseItem_id, 0, 0, 1, null, @Html, @CourseLessonId, @BasicInformationId,@TemplateId,(SELECT ISNULL((SELECT MAX(Position) FROM Edu_CourseLessonItem WHERE IsDeleted = 0 AND CourseLessonId =@CourseLessonId),0)+1),@Youtube); 
