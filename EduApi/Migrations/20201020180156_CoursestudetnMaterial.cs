...
{
    public partial class CoursestudetnMaterial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE PROCEDURE SaveActiveSlide
...
(Id,IsDeleted,IsSystemObject,IsChanged,SystemIdentificator,UserId,CourseLessonItemId,CourseId)
VALUES
(NEWID(),0, 0, 1, null, @userId,@slideId,@courseId);
END
else begin
Update Link_CouseStudentMaterial set CourseLessonItemId =@slideId WHERE Id =@editId
end
