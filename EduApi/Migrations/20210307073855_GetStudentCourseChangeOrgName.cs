...
{
    public partial class GetStudentCourseChangeOrgName : Migration
    {
...
sbieo.Name AS OrganizationName,
...
JOIN Cb_TimeTable AS ttf on  ct.TimeFromId = ttf.Id and ttf.IsDeleted = 0
 JOIN Cb_TimeTable AS ttt on  ct.TimeToId = ttt.Id and ttt.IsDeleted = 0
  ...
  JOIN Shared_BasicInformation AS sbieo ON sbieo.Id =  eo.BasicInformationId AND sbieo.IsDeleted = 0
