...
{
    public partial class AlterGetCourseLessonItemDetail2 : Migration
    {
...
RETURN 
( 
SELECT ci.Id, ci.Html, sbi.Name, sbi.Description, ci.CourseLessonItemTemplateId, clit.SystemIdentificator AS TemplateIdentificator
