...
{
    public partial class AlterAddCourseLessonItemReturnValue : Migration
    {
...
(Id, IsDeleted, IsSystemObject, IsChanged, SystemIdentificator, Html, CourseLessonId, BasicInformationId,CourseLessonItemTemplateId) VALUES 
(@Edu_CourseItem_id, 0, 0, 1, null, @Html, @CourseLessonId, @BasicInformationId,@TemplateId); 
