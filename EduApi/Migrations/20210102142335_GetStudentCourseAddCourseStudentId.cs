...
{
    public partial class GetStudentCourseAddCourseStudentId : Migration
    {
...
ct.Monday,ct.Thursday,ct.Wednesday,ct.Tuesday, ct.Friday, ct.Saturday, ct.Sunday,osbi.Name AS OrganizationName,ct.Id AS TermId,lcs.Id AS CourseStudentId
