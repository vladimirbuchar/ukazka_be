...
{
    public partial class AlterAddCourseLessonAddPosition : Migration
    {
...
(@Edu_CourseLesson_id, 0, 0, 1, null, @CourseId, @BasicInformationId,@Type,(SELECT ISNULL((SELECT MAX(Position) FROM Edu_CourseLesson WHERE IsDeleted = 0 AND CourseId ='C38E5433-85E4-4B5A-AC33-17FACA9F62B3'),0)+1) ); 
