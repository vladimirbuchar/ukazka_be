...
{
    public partial class GetTimeTableAdd : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE FUNCTION GetTimeTable(@courseTermId uniqueidentifier)
RETURNS TABLE  AS
RETURN 
( 
...
WHERE ctd.Id = @courseTermId AND ctd.IsDeleted = 0
