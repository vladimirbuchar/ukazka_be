...
{
    public partial class CreateCourseSendMessageId : Migration
    {
...
(Id, IsDeleted, IsSystemObject, IsChanged, SystemIdentificator, CourseTypeId, CourseStatusId, IsPrivateCourse, OrganizationId, BasicInformationId, CoursePriceId, StudentCountId,CertificateId,AutomaticGenerateCertificate,CourseMaterialId,SendMessageId,SendEmail) VALUES 
(@Edu_Course_id, 0, 0, 1, null, @CourseTypeId, @CourseStatusId, @IsPrivateCourse, @OrganizationId, @BasicInformationId, @CoursePriceId, @StudentCountId,@CertificateId,@AutomaticGenerateCertificate,@CourseMaterialId,@EmailTemplateId,@SendEmail); 
...
SendMessageId = @EmailTemplateId,SendEmail =@SendEmail
WHERE Id=@CourseId
