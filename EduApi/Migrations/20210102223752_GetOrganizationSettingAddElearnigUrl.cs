...
{
    public partial class GetOrganizationSettingAddElearnigUrl : Migration
    {
...
RETURN 
( 
SELECT eos.OrganizationId,eos.UserDefaultPassword, eo.LicenseId, dco.CultureId AS DefaultCulture, eos.ElearningUrl from Edu_OrganizationSetting as eos
