...
{
    public partial class SaveOrganizationSettingLessonLength : Migration
    {
                        ...
                        BEGIN 
                            ...
                            BEGIN TRY
                                BEGIN TRANSACTION
									...
									(Id,IsDeleted,IsChanged,IsSystemObject, SystemIdentificator,OrganizationId,UserDefaultPassword,ElearningUrl,FacebookLogin,GoogleLogin,PasswordReset,Registration,LessonLength)
									VALUES
									(NEWID(),0,1,0,null,@Edu_Organization_id,@DefaultPassword,@ElearningUrl,1,1,1,1,0)
