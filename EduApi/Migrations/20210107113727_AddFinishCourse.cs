...
{
    public partial class AddFinishCourse : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE PROCEDURE FinishCourse
...
BEGIN TRY
BEGIN TRANSACTION
UPDATE Link_CourseStudent SET CourseFinish = 1 WHERE Id =@courseStudentId
COMMIT
END TRY
BEGIN CATCH
ROLLBACK
...
ct.Monday,ct.Thursday,ct.Wednesday,ct.Tuesday, ct.Friday, ct.Saturday, ct.Sunday,osbi.Name AS OrganizationName,ct.Id AS TermId,lcs.Id AS CourseStudentId,lcs.CourseFinish
