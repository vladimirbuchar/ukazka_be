...
{
    public partial class CreateOrganizationAddUrl : Migration
    {
                        ...
                        BEGIN 
                            ...
                            BEGIN TRY
                                BEGIN TRANSACTION
									...
									(Id,IsDeleted,IsChanged,IsSystemObject, SystemIdentificator,OrganizationId,UserDefaultPassword,ElearningUrl)
									VALUES
									(NEWID(),0,1,0,null,@Edu_Organization_id,@DefaultPassword,@ElearningUrl)
